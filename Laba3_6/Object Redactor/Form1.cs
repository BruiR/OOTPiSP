...
namespace Object_Redactor
{
    ...
    {
        public Type[] classes;
        public Type[] serializations;
        public Type[] plugins;
        public Type[] adapters;
        public Assembly library;
        public Assembly slibrary;
        public Assembly plibrary;
        public Assembly alibrary;
        public List<object> listOfObjects;
        ObjectRedactorHelper ObjHelper;
        public Form1()
        {
            InitializeComponent();
            ...
            foreach (Type element in adapters)
            {
                if (element.Name == "BinAdapter")
                    Serialization_comboBox.Items.Add(element.Name);
            }
